...
import tasks
from datasets.dataset import store_to_dataset_goal, load_dataset_goal
...
def main(cfg):
    ...
    synchronized_dataset = load_dataset_goal(n_perspectives, data_path)
    ...
    while len(synchronized_dataset) < cfg['n']:
        ...
        if save_data and total_reward > 0.99:
            ...
            store_to_dataset_goal(synchronized_dataset,
                                  observations, grasp_pose, info=None, seed=seed)
